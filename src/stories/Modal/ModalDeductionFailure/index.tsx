...
interface ModalDeductionFailureProps {
  open: boolean;
...
export const ModalDeductionFailure: React.FC<ModalDeductionFailureProps> = (props) => {
              ...
              <div className={styles.content}>
                <div className='w-full flex flex-wrap justify-center gap-[22px]'>
                  ...
                  <div className='w-full font-primary-regular text-lg text-center'>
                    This deduction was unsuccessful!
                  </div>
                </div>
                ...
                <div className='max-w-[350px] w-full'>
                  <Button
                    title='Pay Now (If Balance Open) Else Close'
                    fullWidth
