...
import { Policy } from 'stories/Policy';
...
const Settings = () => {
    ...
    if (validate) {
      if (userDetails) {
        ...
        if (mobile && mobile !== phone) {
          // navigate('/dashboard/settings/verify');
  ...
  return viewport === 'desktop' ? (
    <div className={styles.container}>
      <div className='text-[32px] font-secondary-bold font-primary-blue-color mb-[25px]'>
        Settings
      </div>

      <div className='grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 lg:gap-8'>
        {/* first column part */}
        <div className='flex flex-wrap justify-center items-center bg-white pt-7 px-8 pb-10 rounded-lg'>
          <div className='w-full text-center font-primary-medium text-lg'>
            Update my information
          </div>
          <div className='w-full text-center font-primary-light text-sm mt-3'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </div>
          <div className='full-divider mt-6 mb-9' />
          {/* first name part */}
          ...
          <div className='w-full'>
            <InputPhone
              label='Phone Number (Will need to be verified if updated)'
              phone={phone}
          ...
          <div className='w-full'>
            <InputAddress
              ...
              address={address01}
              addressValidate={address01Validate}
              getAddress={(value: any) => fillAddressFields(value)}
              size='h40'
            />
          </div>
          {/* address line 2 part */}
          <div className='w-full'>
            <InputAddress1
              ...
              name={address02}
              nameValidate={address02Validate}
              getName={(value: any) => getAddress02(value)}
              size='small'
              errorMessage='Address line 2 is required'
            />
          </div>
          <div className='w-full grid grid-cols-1 lg:grid-cols-2 gap-x-2 md:gap-x-4 lg:gap-x-8'>
            {/* state part */}
            <div className='w-full'>
              <SelectState
        ...
        {/* second column part */}
        <div className='flex flex-wrap justify-center items-center bg-white pt-7 px-8 pb-10 rounded-lg h-fit'>
          <div className='w-full text-center font-primary-medium text-lg'>Change password</div>
          <div className='w-full text-center font-primary-light text-sm mt-3'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </div>
          <div className='full-divider mt-6 mb-9' />
          {/* current password part */}
          <div className='w-full'>
            <InputPassword
    ...
    <div className={styles.mobileContainer}>
      <div className='w-full flex justify-center font-secondary-bold font-primary-blue-color text-2xl mt-10 mb-[42px]'>
        Settings
      </div>
      {/* scroll tab part */}
      <Tab
      ...
      />
      {activeTab === 0 && (
        <div className='w-full flex flex-wrap justify-center items-center mt-[42px] px-6 pt-[42px] pb-[52px]'>
          <div className='w-full text-center font-primary-medium font-black-color text-lg'>
            Update my information
          </div>
          <div className='w-full text-center font-primary-light font-grey-color text-sm mt-[13px]'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </div>
          {/* content part */}
          {/* first name part */}
